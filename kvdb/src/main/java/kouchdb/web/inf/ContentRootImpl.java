...
import kouchdb.CompressionTypes;
...
import static kouchdb.util.Rfc822HeaderState.HttpRequest;
import static kouchdb.util.Rfc822HeaderState.HttpResponse;
...
public class ContentRootImpl extends Impl implements PreRead {
  ...
  private String rootPath = KouchNamespace.KOUCH_DEFAULT_FS_ROOT;
  ...
  public void onRead(SelectionKey key) throws Exception {
    ...
    cursor =
        null == cursor ? ByteBuffer.allocateDirect(kouchdb.Server.getReceiveBufferSize()) : cursor.hasRemaining()
    ...
    Buffer flip = cursor.duplicate().flip();
      ...
      HttpRequest req = new Rfc822HeaderState().addHeaderInterest(Accept$2dEncoding,
              If$2dModified$2dSince, If$2dUnmodified$2dSince).$req();
      boolean apply = req.apply((ByteBuffer) flip);
  ...
  public void onWrite(SelectionKey key) throws Exception {
    ...
    if (send200) {
      ...
      final int sendBufferSize = Server.getSendBufferSize();
